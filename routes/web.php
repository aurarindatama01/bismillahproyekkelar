...
Route::get('/adminserver', function () {
    return view('pages.superadmin.sekolah.showSekolahList');
});
Route::get('/adminserver/createsekolah', function () {
    return view('pages.superadmin.sekolah.createsekolah');
});
Route::get('/adminserver/editsekolah', function () {
    return view('pages.superadmin.sekolah.editsekolah');
});
...
Route::get('/Superadmin', 'SuperadminController@index')->middleware('role:Superadmin');
...
//Sekolah
// Photo Profile
Route::get('/Superadmin/Sekolah/Profile/Picture/{id}', 'SuperadminController@profilePictureAdmin')->middleware('role:Superadmin');
Route::post('/Superadmin/Sekolah/Profile/Picture/Send/{id}', 'SuperadminController@updateAvatarAdmin')->middleware('role:Superadmin');
// Profile Details
Route::get('/Superadmin/Sekolah/Profile/{id}', 'SuperadminController@showProfileAdmin')->middleware('role:Superadmin');
Route::put('/Superadmin/Sekolah/Profile/Send/{id}', 'SuperadminnController@editProfileAdmin')->middleware('role:Superadmin');
Route::post('/Superadmin/Sekolah/Profile/changePassword/{id}', 'SuperadminController@editPasswordAdmin')->middleware('role:Superadmin');
// Create Student
Route::get('/Superadmin/Sekolah/Create', 'SuperadminController@showCreateAdmin')->middleware('role:Superadmin');
Route::post('/Superadmin/Sekolah/Create/Send', 'SuperadminController@createAdmin')->middleware('role:Superadmin');
Route::get('/Superadmin/Sekolah/List', 'SuperadminController@showAdminList')->middleware('role:Superadmin');
// Show Search Result
Route::get('/Superadmin/Sekolah/List/Search', 'SuperadminController@searchAdmin')->middleware('role:Superadmin');
// Delete Student
Route::get('/Superadmin/Sekolah/Delete/{id}', 'SuperadminController@deleteAdmin')->middleware('role:Superadmin');


Route::get('/Superadmin/Profile', 'SuperadminController@showProfile')->middleware('role:Superadmin');
Route::put('/Superadmin/Profile/{id}', 'SuperadminController@editProfile')->middleware('role:Superadmin');
Route::post('/Superadmin/Profile/changePassword/{id}', 'SuperadminController@editPassword')->name('superadmin.profile.change.password')->middleware('role:Superadmin');
