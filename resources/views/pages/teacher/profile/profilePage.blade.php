                    ...
                    <div class="card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Teacher/Profile/Send">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="tgl_lahir" type="date" class="form-control" placeholder="Tanggal Lahir, misal: 05" value="{{ $user->tgl_lahir }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input  name="nip" type="text" class="form-control" placeholder="Nomor NIP" value="{{ $user->nip }}">
                                            @if($errors->has('nip'))
                                                <div class="text-danger">
                                                    {{ $errors->first('nip')}}
                                                </div>
                            ...
                            <div class="tab-pane" id="password">
                                ...
                                <!-- End of Success And Fail/Error Alert -->
                                <form class="form-horizontal" method="post" action="/Teacher/Profile/changePassword/{{ $user->id }}">
                                    @csrf
                                    {{ method_field('POST') }}
                                    <div class="form-group row">
