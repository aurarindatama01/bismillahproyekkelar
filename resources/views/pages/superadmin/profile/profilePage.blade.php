                    ...
                    <div class="card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Superadmin/Profile/{{ $user->id }}">
                                    @csrf
                                    {{ method_field('PUT') }}
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                                        <div class="col-sm-10">
                                            <input name="name" type="name" class="form-control" id="inputName" placeholder="Name" value="{{ $user->name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="no_telp" type="integer" class="form-control"  placeholder="No. Telp" value="{{ $user->no_telp }}">
                            ...
                            <div class="tab-pane" id="password">
                                ...
                                <!-- End of Success And Fail/Error Alert -->
                                <form class="form-horizontal" method="post" action="/Superadmin/Profile/changePassword/{{ $user->id }}">
                                    @csrf
                                    {{ method_field('POST') }}
                                    <div class="form-group row">
