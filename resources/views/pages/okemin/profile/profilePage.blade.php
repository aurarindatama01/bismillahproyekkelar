                    ...
                    <div class="card">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" method="post" action="/Okemin/Profile/{{ $user->id }}">
                                    @csrf
                                    {{ method_field('PUT') }}
                            ...
                            <div class="tab-pane" id="password">
                                ...
                                <!-- End of Success And Fail/Error Alert -->
                                <form class="form-horizontal" method="post" action="/Okemin/Profile/changePassword/{{ $user->id }}">
                                    @csrf
                                    {{ method_field('POST') }}
                                    <div class="form-group row">
