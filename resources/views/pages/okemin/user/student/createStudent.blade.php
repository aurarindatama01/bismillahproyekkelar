            ...
            <div class="card card-primary">
                ...
                <form role="form" action="/Okemin/User/Student/Create/Send" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="name" type="name" class="form-control" id="input1" placeholder="Nama Siswa">
                            @if($errors->has('name'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="tgl_lahir" type="date" class="form-control" id="input3" placeholder="Tanggal lahir, Misal: 26">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="jenis_kelamin" type="text" class="form-control" id="input4" placeholder="Jenis Kelamin">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="agama" type="text" class="form-control" id="input5" placeholder="Agama">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="nisn" type="text" class="form-control" id="input6" placeholder="Nomor NISN">
                            @if($errors->has('nisn'))
                                <div class="text-danger">
                                    {{ $errors->first('nisn')}}
                                </div>
                    ...
                    <div class="form-group row">
                        <label for="input7" class="col-sm-2 col-form-label">Kelas*</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="username" type="text" class="form-control" id="input9" placeholder="Username">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="email" type="email" class="form-control" id="input10" placeholder="E-mail">
                            @if($errors->has('email'))
                                <div class="text-danger">
                                    {{ $errors->first('email')}}
                                </div>
                    ...
                    <div class="form-group row">
                        <label for="input14" class="col-sm-2 col-form-label">Nama Sekolah</label>
                        <div class="col-sm-10">
                          <input name="nama_sekolah" type="text" class="form-control" id="input2" value="{{ $user->nama_sekolah }}" readonly="disabled">
                    ...
                    <!-- <div class="form-group row">
                        <label for="input14" class="col-sm-2 col-form-label">Nama Sekolah</label>
                        <div class="col-sm-10">
                          <input name="nama_sekolah" type="text" class="form-control" id="input14" placeholder="Nama Sekolah">
                            @if($errors->has('nama_sekolah'))
                                <div class="text-danger">
                                    {{ $errors->first('nama_sekolah')}}
                                </div>
